...
export default function PrivacyPolicy() {
  return (
    <div className="pt-5 pb-10 px-10 max-w-3xl flex flex-col mx-auto gap-y-5 items-center">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Luna-Latte Cafe.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Luna-Latte Cafe, accessible from{" "}
            <a
              href="http://www.luna-latte.cafe"
              rel="external nofollow noopener"
              target="_blank"
            >
              http://www.luna-latte.cafe
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: lunalatteph@gmail.com</p>
        </li>
        <li>
          <p>By phone number: 09091957066</p>
        </li>
      </ul>
    </div>
  );
